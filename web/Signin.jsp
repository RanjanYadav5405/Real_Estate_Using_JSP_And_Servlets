...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <form class="form-signin" action="your_login_servlet" method="post">
                    ...
                    <div class="buttons">
                        <button class="ml-3" id="loginBtn" type="submit" onclick="window.location.href='Dashboard.jsp'">Login</button>
